...
public enum UserErrorCode implements ErrorCode {
    ...
    USER_ACTIVITY_NOT_FOUND("USER_ACTIVITY_NOT_FOUND", "유저 활동 정보를 찾을 수 없습니다.", HttpStatus.NOT_FOUND),
    DUPLICATE_NICKNAME("DUPLICATE_NICKNAME", "동일한 닉네임을 가진 유저가 존재합니다.", HttpStatus.BAD_REQUEST);
